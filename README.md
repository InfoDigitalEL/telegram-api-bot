...
const bot = new TelegramApiBot('SEU_TOKEN_DO_BOT_AQUI');  // Susbtitua SEU_TOKEN_DO_BOT_AQUI pelo token do seu bot do telegram

// Enviar uma mensagem
bot.sendMessage('ID_DO_CHAT', 'Olá, mundo!')   // Susbtitua ID_DO_CHAT pelo numero do chat id que voce deseja enviar a mensagem
    .then(response => {
